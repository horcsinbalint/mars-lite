                    ...
                    <tbody>
                        ...
                        <tr>
                            @php
                                ...
                                $absentees = $general_assembly->absentees();
                            @endphp
                            @if($attendees->isEmpty() && $absentees->isEmpty())
                            <th scope="row">@lang('voting.cannot_determine_attendees')</th>
                            @else
                            ...
                            <th scope="row">@lang('voting.absentees') ({{$absentees->count()}} fő)*</th>
                            <td>
                                <ul>
                                @foreach ($absentees->sortBy('name') as $absentee)
                                    <li>{{ $absentee->uniqueName }}</li>
                                @endforeach
                                </ul>
                            </td>
                            @endif
